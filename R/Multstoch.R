...
#' @param wxtnormm2 mean of truncated normal distribution of weather parameter (8-27)
#' @param wxtnormsd2 sd of truncated normal distribution of weather parameter (8-27)
#' @param wxd2 set of potential weather variables from which one is drawn in each time step (8-27)
#' @param wdsamp2 if T, a set of potential weather variables is read (wxd); if F, defaults to reading a mean and variance for environmental effects (wxtnormm and extnormsd)(8-27)
...
Multstoch <- function(pHSinit2=0.8, Kx2 = 100, betax2=0.02, wxtnormm2=0.8, wxtnormsd2=0.3, wxd2=NULL, wdsamp2=NULL, hx2=1, mxtnormm2=1, mxtnormsd2=0.1, axtnormm2=1, axtnormsd2=0.1, rx2=0.1, zxtnormm2=1, zxtnormsd2= 0.1, gx2=4, cx2=0.9, phix2=0, nseasons2=10, nsim2=10, HPcut2=0.5,pHScut2=0.5,maY2=100, miY2=0, thetax2=0.2, Ex2=0) {
...
for(si in 1:nsim2) {
temp <- SeasModstoch(pHSinit=pHSinit2, Kx = Kx2, betax=betax2, wxtnormm=wxtnormm2, wxtnormsd=wxtnormsd2, wxd=wxd2, wdsamp=wdsamp2, hx=hx2, mxtnormm=mxtnormm2, mxtnormsd=mxtnormsd2, axtnormm=axtnormm2, axtnormsd=axtnormsd2, rx=rx2,zxtnormm=zxtnormm2, zxtnormsd= zxtnormsd2, gx=gx2, cx=cx2, phix=phix2, nseasons=nseasons2, HPcut=HPcut2, pHScut=pHScut2, maY=maY2, miY=miY2, thetax=thetax2, Ex=Ex2)$outfin   
